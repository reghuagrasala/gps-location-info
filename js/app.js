import{startGPS,retryGPS,onGPS,diagnostic}from "./gps.js?v=36";
...
function show(id){
 ...
 if(id==="position")setTimeout(()=>{resizeGlobe($("positionGlobe"));if(gps)recenterGlobe($("positionGlobe"),gps,true)},100);
